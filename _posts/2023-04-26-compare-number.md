...
숫자 비교하기 프롬프트는 역할 지정 및 진행순서와 게임 규칙을 알려주는 지, 게임의 진행방식을 보여주는 ,
숫자 비교하기 프롬프트의 조건을 입력할 수 있는 조건이 있습니다.
...
**1. INPUT ("Enter a range of numbers"):1-20 

첫번째 INPUT에는 비교를 할 수 있는 수의 범위를 입력합니다. 예시에서 ChatGPT는 1부터 20까지의 숫자 범위 내에서 숫자를 고를 수 있습니다.

**2. INPUT ("Enter the number of values to compare"): 3*
...
**1. INPUT ("Enter a range of numbers"):1-30 

**2. INPUT ("Enter the number of values to compare"): 5*
...
사진에서는 ChatGPT가 (15,3,27,8,2 숫자들을 제시했고 답변을 통해 ChatGPT가 제시한 숫자들을 
위 사진처럼 큰 순서대로 나열합니다. (27,20,15,8,
