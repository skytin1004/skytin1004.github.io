...
앞으로 airflow에 대한 공부를 많이 해서 시스템 내부를 손 보거나 버그를 고치고 새로운 기능을 추가해
보는 것이 목표입니다.


 오픈소스에 기여하는 방법은 다양합니다. 오픈소스의 핵심 기능을 추가하거나 주요 버그를 수정 하는 것 뿐만 아니라 문서를 변역하거나 오탈자를 수정함으로써 오픈소스에 기여할 수 있습니다. 

![img](https://drive.google.com/uc?id=1yISWUzCTd_8DsWiShBC9VfGL_PogPMEP)

뿐만 아니라 Issues 메뉴에 들어가서<span style="color:#9370DB">"good first issue"</span> 태그를 검색하면 처음 기여하기 좋은 이슈들이 많이 있습니다. 
...
원래는 이 부분에 첫 오픈소스에 기여한 후기를 작성하려고 했으나 (코드 리뷰 없이)너무 쉽게 성공하는 바람에 조만간 다른 부분에 기여를 하고 후기를 올리겠습니다.
